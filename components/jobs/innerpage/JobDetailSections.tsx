...
import { Bookmark, BookmarkCheck, Share2, CheckCircle, ExternalLink, Building, MapPin, Calendar, Briefcase } from "lucide-react"
...
const JobDetailSections = ({ job, isSaved, onSave, onShare, onApply }: Props) => {
